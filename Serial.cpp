...
// Fragmentor commands
  {"SENA", CMDbool, 1, (char *)&fragdata.Enable},                         // Enables the drive if true
  {"GENA", CMDbool, 0, (char *)&fragdata.Enable},                         // Returns enable status
  {"TUNE",  CMDfunction, 0, (char *)AutoTune},                            // Auto tune
  {"TUNER",  CMDfunction, 0, (char *)AutoTuneReport},                     // Auto tune, with reporting
  {"RADC",  CMDfunction, 1, (char *)ReadADC},                             // Read the selected ADC channel
  {"SFREQ", CMDint, 1, (char *)&fragdata.Freq},                           // Sets frequency 
  {"GFREQ", CMDint, 0, (char *)&fragdata.Freq},                           // Returns frequency 
  {"SMFREQ", CMDint, 1, (char *)&fragdata.MaxFreq},                       // Sets upper frequency limit
  {"GMFREQ", CMDint, 0, (char *)&fragdata.MaxFreq},                       // Returns upper frequency limit
  {"SDRV", CMDfloat, 1, (char *)&fragdata.Drive},                         // Sets drive 
  {"GDRV", CMDfloat, 0, (char *)&fragdata.Drive},                         // Returns drive 
  {"SRFV", CMDfloat, 1, (char *)&fragdata.Setpoint},                      // Sets RF voltage setpoint 
  {"GRFV", CMDfloat, 0, (char *)&fragdata.Setpoint},                      // Returns RF voltage setpoint
  {"GRFAVA", CMDfloat, 0, (char *)&RFvoltageA},                           // Returns RF voltage actual value phase A
  {"GRFAVB", CMDfloat, 0, (char *)&RFvoltageB},                           // Returns RF voltage actual value phase B
  ...
  {"SGAIN", CMDfloat, 1, (char *)&fragdata.Gain},                         // Sets closed loop gain
  {"GGAIN", CMDfloat, 0, (char *)&fragdata.Gain},                         // Returns closed loop gain
  {"SMODE", CMDbool, 1, (char *)&fragdata.Mode},                          // Sets mode, TRUE = closed loop mode, FALSE = open loop
  {"GMODE", CMDbool, 0, (char *)&fragdata.Mode},                          // Returns mode
  {"SMDRV", CMDfloat, 1, (char *)&fragdata.MaxDrive},                     // Sets max drive level
  {"GMDRV", CMDfloat, 0, (char *)&fragdata.MaxDrive},                     // Returns max drive level
  {"SMPWR", CMDfloat, 1, (char *)&fragdata.MaxPower},                     // Sets max power level
  {"GMPWR", CMDfloat, 0, (char *)&fragdata.MaxPower},                     // Returns max power level
  // Arc detection commands
  {"SARCENA", CMDbool, 1, (char *)&fragdata.arcdDetEna},                  // Sets Arc detect enable state, TRUE or FALSE
  {"GARCENA", CMDbool, 0, (char *)&fragdata.arcdDetEna},                  // Returns Arc detect enable state
  {"SARCSEN", CMDfloat, 1, (char *)&fragdata.arcSens},                    // Sets Arc detection sensativity, default 0.5
  {"GARCSEN", CMDfloat, 0, (char *)&fragdata.arcSens},                    // Returns Arc detection sensativity
  // Watch dog timer, watch dog timer state only changed on power up
  {"SWDT", CMDbool, 1, (char *)&fragdata.watchDog},                       // Sets watch dog timer enable state, TRUE or FALSE
  {"GWDT", CMDbool, 0, (char *)&fragdata.watchDog},                       // Returns watch dog timer enable state
  {"SSWD", CMDbool, 1, (char *)&fragdata.serialWatchDog},                 // Sets serial IO watch dog enable state, TRUE or FALSE
  {"GSWD", CMDbool, 0, (char *)&fragdata.serialWatchDog},                 // Returns serial IO watch dog enable state
 
// Calibration command
  {"CALRFA", CMDfunction, 0, (char *)CalibrateRFA},
  {"CALRFB", CMDfunction, 0, (char *)CalibrateRFB},
  {"CALCUR", CMDfunction, 0, (char *)CalibrateCurrent},
// End of table marker
  {0},
};
